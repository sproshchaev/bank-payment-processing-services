...
insert into client (last_name, first_name, middle_name, birth_date, document, address, phone)
values ('Иванов', 'Иван', 'Иванович', '1980-01-30', '1234 123456 выдан 01.01.2000 УВД г.Москвы', 'Москва, ул.Шаболовская, 37 кв. 20', '+79221234567'),
       ('Петров', 'Семен', 'Егорович', '1989-12-31', '5678 789012 выдан 20.10.2012 УВД г.Санкт-Петербурга', 'Санкт-Петербург, Лиговский пр-т, 96 кв. 15', '+79121234568'),
       ('Сидоров', 'Дмитрий', 'Степанович', '1976-10-20', '9012 345678 выдан 16.07.2018 УВД г.Тюмени', 'Тюмень, ул.Республики, 21 кв. 12', '+79041234569');
